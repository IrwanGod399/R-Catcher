...
--*/
{
    ...
    printf("\nStatus: %08lx:%p ", RecordData->Status, (PVOID)RecordData->Information);
    printf("\nPID: %8Iu", RecordData->ProcessId);
    printf("\nProcess: ");
    printf("%-15.15s ", RecordData->ProcessName);
    printf("\nName: %S", Name);
    
    //printf("\nTID: %-4Iu", RecordData->ThreadId);
    printf("\nIRP_CODE: ");
    PrintIrpCode( RecordData->CallbackMajorId,
                  RecordData->CallbackMinorId,
                  NULL,
